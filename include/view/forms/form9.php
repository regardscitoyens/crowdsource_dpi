<p class="consigne">Merci de saisir ci-dessous une ligne par fonction ou mandat déclaré par le parlementaire.</p>
...
<table id="crowdtable" class="table">
  ...
  <tr class="row userline">
    <td><textarea name="champ[0,0]" placeholder="Fonction ou mandat n°1" class="form-control"></textarea></td>
    <td><textarea name="champ[0,1]" placeholder="Dates de début et de fin n°1" class="form-control"></textarea></td>
  ...
  <tr class="row userline">
    <td><textarea name="champ[1,0]" placeholder="Fonction ou mandat n°2" class="form-control"></textarea></td>
    <td><textarea name="champ[1,1]" placeholder="Dates de début et de fin n°2" class="form-control"></textarea></td>
