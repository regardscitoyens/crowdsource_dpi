...
<table id="crowdtable" class="table">
  ...
  <tr class="row userline">
    ...
    <td><textarea name="champ[0,1]" placeholder="Modalité n°1" class="form-control"></textarea></td>
  ...
  <tr class="row userline">
    ...
    <td><textarea name="champ[1,1]" placeholder="Modalité n°2" class="form-control"></textarea></td>
