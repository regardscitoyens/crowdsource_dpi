...
<table id="crowdtable" class="table">
  ...
  <tr class="row userline">
    <td><textarea id="champ[0,0]" placeholder="Employeur n°1" class="form-control"></textarea></td>
    <td><textarea id="champ[0,1]" placeholder="Modalité n°1" class="form-control"></textarea></td>
  ...
  <tr class="row userline">
    <td><textarea id="champ[1,0]" placeholder="Employeur n°2" class="form-control"></textarea></td>
    <td><textarea id="champ[1,1]" placeholder="Modalité n°2" class="form-control"></textarea></td>
